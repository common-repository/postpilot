...
class Options {
	 ...
	 * @const string
	 */
	const OPTION_GROUP = 'postpilot-auth';
	 ...
	 * @const string
	 */
	const OPTION_NAME = 'postpilot-auth-secret';
	...
	/**
	 * Register postpilot-post-secret option.
	 */
	...
	public static function set_initial_secret() {
		$secret = HMAC_Auth::generate_secret();
